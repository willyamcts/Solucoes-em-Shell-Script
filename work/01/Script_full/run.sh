...
#	MAC, usuário PPPOE, AP conectado e seu respectivo sinal; habilita 
#	Compliance Teste e alteração de canal(is) em massa; também é 
...
#	22 e 7722.Aplicável somente a AirOS5 atuando em 5.8 GHz.
#
